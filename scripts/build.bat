...
i686-elf-gcc -ffreestanding -c boot/kernel.c -o build/kernel.o
if errorlevel 1 goto :error

echo Compiling terminal.c...
i686-elf-gcc -ffreestanding -c boot/terminal.c -o build/terminal.o
if errorlevel 1 goto :error

echo Compiling idt.c...
i686-elf-gcc -ffreestanding -c boot/idt.c -o build/idt.o
if errorlevel 1 goto :error

echo Compiling isr.c...
i686-elf-gcc -ffreestanding -c boot/isr.c -o build/isr.o
if errorlevel 1 goto :error

echo Assembling isr.asm...
nasm -f elf32 boot/isr.asm -o build/isr_asm.o
if errorlevel 1 goto :error
